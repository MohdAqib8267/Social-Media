...
const Chat = () => {
  ...
  const [sendMessage,setSendMeesage]=useState(null);
  ...
  return (
    <div className="Chat">
      ...
      <div className="Right-side-chat">
        ...
        {/* chat body */}
        <ChatBox chat={currentChat} currentUser={user.user._id} setSendMeesage={setSendMeesage}  receivedMessage={receivedMessage}/>
      </div>
    </div>
  );
};
